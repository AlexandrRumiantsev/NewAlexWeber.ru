...
## Требования к исходным кодам и языкам программирования.
Язык программирования - JavaScript. Версия - ES7. Node.js - для серверной части. vue.js(поль) , react.js - для разработки интерфейса(). Документирование кода - JSDoc. Тесты - Jest.
