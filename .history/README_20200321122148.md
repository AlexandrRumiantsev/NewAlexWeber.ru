...
Проект "Портфолио веб разработчика", предназначен для написания соовременного веб приложения, в котором представленна возможность демонстрировать персональные разработки и разрабатывать и демонстрировать. 
