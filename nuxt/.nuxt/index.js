...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"ecommerce-netlify","script":[{"src":"https:\u002F\u002Fjs.stripe.com\u002Fv3\u002F"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"A serverless function to process stripe payments with Nuxt, Netlify, and Lambda"}],"link":[{"rel":"stylesheet","href":"https:\u002F\u002Ffonts.googleapis.com\u002Fcss?family=Montserrat:300,600|PT+Serif&display=swap"}],"style":[]},
